...
final class UsageHubProvider: ProviderRuntime {
    ...
    let codexUsageClient: CodexUsageClient
    let claudeUsageClient: ClaudeUsageClient
    ...
    init(
        ...
        let tunnel = client.tunnel(authIndex: source.account.authIndex)
        self.client = client
        self.codexUsageClient = CodexUsageClient(http: tunnel)
        self.claudeUsageClient = ClaudeUsageClient(httpClient: tunnel)
